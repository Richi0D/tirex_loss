...
def score_data(y_true, y_pred, y_train, quantiles, model_path=None, feature_names=None, log_prefix:Optional[str]=None):
    """score the model
    ...
    score_smape = symmetric_mean_absolute_percentage_error(y_true, mean_pred, multioutput='raw_values')
    score_mase = mean_absolute_scaled_error(y_true, mean_pred, y_train, multioutput='raw_values')
    score_r2 = r2_score(y_true, mean_pred, multioutput='raw_values')
