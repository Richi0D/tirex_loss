...
\begin{table}[htbp]
	...
	\begin{threeparttable}
		...
		\begin{tabular}{lllcccc}
			...
			\addlinespace
			MH & lstm & l1       & \cellcolor[HTML]{fdfebc}0.6691 & 0.7104 & - & - \\
			MH & lstm & mse      & 0.5670 & \cellcolor[HTML]{fdfebc}0.5582 & -  & -  \\
			MH & lstm & quantile & \cellcolor[HTML]{fdfebc}0.6745 & 0.6866 & 11.9533 & 12.7776 \\
			\addlinespace
			MH & slstm & l1      & \cellcolor[HTML]{fdfebc}0.6713 & 0.7691 & - & - \\
			MH & slstm & mse     & \cellcolor[HTML]{fdfebc}0.6578 & 0.7180 & - & - \\
			MH & slstm & quantile & \cellcolor[HTML]{fdfebc}0.6720 & 0.6888 & 11.8404 & 12.7920 \\
			\midrule
...
CPM has a large impact on training and clearly improves model performance: all CPM scores in \autoref{tab:scores_custom_tirex_full} are better than those of mask horizon. The models evidently learn better when trained with randomly scattered masked patches (CPM) than with a single, large masked block near the end of the sequence (MH). It appears that MH removes too much information from the context at once, making the task considerably harder to learn from.
...
\begin{table}[htbp]
	...
	\begin{threeparttable}
		...
		\begin{tabular}{lllcccc}
			...
			\addlinespace
			MH & lstm & l1       & \cellcolor[HTML]{fdfebc}0.7104 & 0.7106 & - & - \\
			MH & lstm & mse      & \cellcolor[HTML]{fdfebc}0.5582 & 0.5791 & -  & -  \\
			MH & lstm & quantile & 0.6866 & \cellcolor[HTML]{fdfebc}0.6658 & \cellcolor[HTML]{fdfebc}12.7776 & 13.0410 \\
			\addlinespace
			MH & slstm & l1      & \cellcolor[HTML]{fdfebc}0.7691 & 0.7797 & - & - \\
			MH & slstm & mse     & \cellcolor[HTML]{fdfebc}0.7180 & 0.7263 & - & - \\
			MH & slstm & quantile & 0.6888 & \cellcolor[HTML]{fdfebc}0.6806 & 12.7920 & \cellcolor[HTML]{fdfebc}12.4812 \\
			\bottomrule
		\end{tabular}
		\begin{tablenotes}
			\small
...
\begin{table}[htbp]
	...
	\begin{tabular}{llllrrr}
		\toprule
		\textbf{Dataloader} & \textbf{Layer} & \textbf{Loss} & \textbf{Total Epochs} & \textbf{Best Train Loss} & \textbf{Best Validation Loss}\\
		\midrule
		MH & slstm & quantile & 100 & 74.78 & 559.20 \\
		MH & lstm  & quantile & 100 & 41.41 & 571.46 \\
		...
		\midrule
		MH & slstm & mse      & 100 & 2,901,915 & 4,634,443 \\
		MH & lstm  & mse      & 100 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}46,591 & 9,396,074  \\
		cpm & slstm    & mse      & 100 & 97,453.89 & 8,169,185.35  \\
		cpm & lstm      & mse      & 100 & 59,365.80 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}7,820,493.16 \\
		\midrule
		MH & slstm & l1       & 100 & 1,246.28 & 1,534.37  \\
		MH & lstm  & l1       & 100 & 1,002.50 & 1,388.01  \\
...
\begin{table}[htbp]
	...
	\begin{threeparttable}
		...
		\begin{tabular}{lllrrr}
			...
			\textbf{Dataloader} & \textbf{Layer} & \textbf{Loss} & \textbf{Total Epochs} & \textbf{Best Train Loss} & \textbf{Best Validation Loss}\\
			\midrule
			MH & slstm & quantile & 100 & 543.71 $\pm$ 7.83 & 612.24 $\pm$ 6.96 \\
			MH & lstm  & quantile & 100 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}399.73 $\pm$ 3.77 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}545.44 $\pm$ 4.27 \\
			\midrule
			MH & slstm & mse      & 100 & 3,483,126.45 $\pm$ 72,156.17 & 4,867,615 $\pm$ 16,038 \\
			MH & lstm  & mse      & 100 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}1,219,947 $\pm$ 69,377.99 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}3,730,064$\pm$ 200,138  \\
			\midrule
			MH & slstm & l1       & 100 & 1,326.44 $\pm$ 17.14 & 1,551.57 $\pm$ 20.72  \\
			MH & lstm  & l1       & 100 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}1,009.09 $\pm$ 31.85 & \cellcolor[HTML]{006837}\color[HTML]{f1f1f1}1,460.09 $\pm$ 39.63  \\
			\bottomrule
		\end{tabular}
		\begin{tablenotes}
			\small
