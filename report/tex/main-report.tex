...
\label{sec:data}
For this work all the datasets collected are located in the energy domain. 

\begin{itemize}[]
	\item Electricity consumption from a single household of 2 Persons in Austria. Collected from the household meter. The timeseries has a interval of 15 minutes and holds around 100k timestamps.
...
\end{align}
The overall quantile loss is obtained by averaging $QL_\tau$ over all evaluated quantile levels $\tau \in \{\tau_1, \dots, \tau_K\}$.
